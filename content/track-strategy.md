...
| coding (LiveCodeBench) | instruct + 테스트 실행 | 실행 채점이라 사고보다 통과 여부가 중요 |
...
**검증은 반드시 코드 실행으로.** 수학은 sympy 검산, 코딩은 테스트 실제 실행. LLM끼리 토론시키는 방식은 토큰을 몇 배로 쓰면서 정확도 향상은 작아 이번 배점 체계에서 최악의 선택입니다.
