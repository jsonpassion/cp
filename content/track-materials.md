...
- **confgate 스윕(n=95)**: gpt-oss 단독 76.8% vs Qwen 65.3% / 게이트 θ=8이면 정확도 72.6%로 하락 + 토큰 1.7배 / 교정 3건 vs 가로챔 14건 — "2차 의견 기각" 장표의 근거 숫자
- **캘리브레이션 곡선**: conf 10→100%(24/24) · 9→79% · 8→65% · ≤3→25% — The Receipt/Insightfulness 재료
...
| 12 | **하이브리드(Adjudicator) 기각, θ=0** | 스윕 결과 게이트가 전 구간 손해: 약한 모델의 2차 의견은 교정 3건 < 정답 가로챔 14건. "좋아 보이는 아이디어를 숫자로 죽였다" | 가설 기각, 소표본 함정(20문항 65%>60%가 95문항에서 역전), 데이터 우선 |
